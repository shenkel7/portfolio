...
export const WorksList : TWork[] = [
    ...
    },
    {
        ...
        <br />
        <br />
        The water in gsdfgsd is warm in the summer, slipping between your ankles like heated silk. It laps at your calves, then your thighs, then your chest, pressing against you with the vigor of a living thing. You will it to carry you outwards, where your father is waiting, tethered by seagrass to his favorite mistress.
        <br />
        <br />
        You look up at the moon. You frown. This is not dsagasdg. But the sea hooks around the crook of your elbow and pulls, and you acquiesce, because water is water everywhere.
